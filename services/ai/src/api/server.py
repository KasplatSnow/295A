...
class AlertServer:
        ...
        try:
            ...
            for row in cameras:
                ...
                return {
                    ...
                    "audio_enabled": bool(row.get("audio_enabled", False)),
    ...
    def _setup_routes(self):
        ...
        async def api_register_camera(
            ...
            audio_enabled: bool = Body(False, description="Enable audio anomaly processing for this camera"),
            ...
            if existing_proc:
                ...
                restart_required = any((
                    ...
                    str(current_cfg.get("source_type", "")) != str(cam_cfg.get("source_type", "")),
                    set(current_cfg.get("enabled_lanes", []) or []) != set(enabled_lanes),
                    current_cfg.get("sample_hz") != sample_hz,
                    bool(current_cfg.get("audio_enabled", False)) != bool(audio_enabled),
